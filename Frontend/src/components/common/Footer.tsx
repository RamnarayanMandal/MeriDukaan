      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex md:justify-start justify-center content-center items-center gap-2 group">
              <img src="/logo.png" alt="Logo" className="h-32 w-32 object-cover rounded-full" />
            </Link>

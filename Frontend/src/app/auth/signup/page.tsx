...
const SignUp = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      // Add User role by default and include confirmPassword
      const signupData = { ...userData, confirmPassword, role: 'admin' as const }
              ...
              <StaggerContainer>
                ...
                <StaggerItem>
                  <HoverLift>
                    ...
                    >
                      {signupMutation.isPending ? 'Creating Account...' : 'Create User Account'}
                    </Button>
                  </HoverLift>
                </StaggerItem>
